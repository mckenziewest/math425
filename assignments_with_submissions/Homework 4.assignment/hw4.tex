...
\textbf{(Group-1)} Consider the set $M=\{\sigma:\N\to\N | \sigma\text{ is one-to-one}\}$.  Show that $M$ is a monoid but it is not a group.  (Make sure to reference appropriate Theorems from Section 0.3 when necessary!)
