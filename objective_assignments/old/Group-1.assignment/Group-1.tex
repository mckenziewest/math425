...
\begin{document}
	...
	\textbf{(Group-1.2)} Show that $G$ is a group with the given operation by showing it satisfies each of the four axioms in the definition of group, or give proof that it fails one of these axioms.
	...
	\textbf{(Group-1.3)}  Show that $G$ is a group with the given operation by showing it satisfies each of the four axioms in the definition of group, or give proof that it fails one of these axioms.
	
	\[G = \R\setminus\{1\};\ a\cdot b=a+b-ab.\]
	
	\newpage
	Name: \underline{\hspace*{3in}}
	\vskip .25in
	
	\textbf{(Group-1.4)}   Show that $G$ is a group with the given operation by showing it satisfies each of the four axioms in the definition of group, or give proof that it fails one of these axioms.
	...
	\textbf{(Group-1.5)} Show that $G$ is a group with the given operation by showing it satisfies each of the four axioms in the definition of group, or give proof that it fails one of these axioms.
	...
	\textbf{(Group-1.6)} Show that $G$ is a group with the given operation by showing it satisfies each of the four axioms in the definition of group, or give proof that it fails one of these axioms.
