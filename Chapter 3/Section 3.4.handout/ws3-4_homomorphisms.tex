...
\newcommand{\secname}{Section 3.4: Homomorphisms}
...
\slide{
	\begin{exercise}
		...
		\enumalph{
			...
			\vfill
			\item What is $\theta^{-1}\left(\begin{bmatrix}\bar0&\bar0\\\bar0&\bar0\end{bmatrix} \right)$?\vfill
		}	
	\end{exercise}
}
...
\slide{
	\begin{exercise}
		...
		Use this map, Theorem 3.4.1, and contradiction to show there are no integers $a,b,c$ for which 
			\[a^3+b^3+c^3=31.\]\vskip 2in
	\end{exercise}
}
\slide{
	\begin{thm}{3.4.2}
