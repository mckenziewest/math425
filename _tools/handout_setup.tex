\usepackage{amsthm,amsmath,amsfonts,hyperref,graphicx,multicol,color,soul}
...
\definecolor{Green}{RGB}{16, 163, 80}
\definecolor{Orange}{RGB}{245, 131, 10}
...
\newtheorem*{innerblock}{\theblock}
\newenvironment{block}[1]
{\renewcommand\theblock{#1}\innerblock}
{\endinnerblock}
\newenvironment{statementblock}[1]
{\renewcommand\theblock{#1}\innerblock}
{\endinnerblock}

\renewcommand{\emph}[1]{{\color{blue}\underline{\texttt{#1}}}}
