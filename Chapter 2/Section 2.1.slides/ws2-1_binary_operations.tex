...
\subtitle{Section 2.1: Binary Operations}
...
\slide{
	\huge\textbf{Let's play}
	\begin{center}
		\includegraphics[width=3.5in]{monoid_game_level}
	\end{center}
}
\begin{frame}[fragile]
	\frametitle{\fn}
...
\end{exercise}
\begin{picture}(0,0)
\put(150,140){\includegraphics[width=2.5in]{monoid_game}}
\end{picture}
\end{frame}
\slide{
\begin{exercise}
...
\begin{picture}(0,0)
\put(150,140){\includegraphics[width=2.5in]{monoid_game}}
\put(160,0){\rotatebox{15}{$GL_2(\R)$ - $2\times 2$ invertible matrices}}
\end{picture}
}
\slide{
	\begin{defn}
