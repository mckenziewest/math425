...
\newcommand{\secname}{Section 2.10: The First Isomorphism Theorem}
...
\slide{
	...
	\end{defn}
	\begin{exercise}
		Let $\alpha:\Z\to \C^*$ be defined by $\alpha(n)=i^n$ where $i^2=-1$.
		
		Compute $\im(\alpha)$.\vskip 1in
		Compute $\ker(\alpha)$.  \vskip 1in
	\end{exercise}
}
...
\newpage
\slide{
	\begin{exercise}Use Theorem 2.10.1 to prove the following.
		\enumalph{
			\item Prove $SL_2(\R)\lhd GL_2(\R)$.\vskip 2in 
			\item Prove $A_n\lhd S_n$.\vskip 2in 
		}
	\end{exercise}
}
